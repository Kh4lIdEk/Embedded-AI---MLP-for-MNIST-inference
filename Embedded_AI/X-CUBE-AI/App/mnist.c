...
#define AI_MNIST_MODEL_SIGNATURE     "0xeee02c863cc60480f2d2327c9bb2a820"
...
#define AI_TOOLS_DATE_TIME   "2026-09-18T08:46:21+0200"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    3648, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MNIST_IN_NUM, &serving_default_input_layer_30_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MNIST_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0xda5cc42c, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_mnist_activations_map, 1, params)) {
    ...
    serving_default_input_layer_30_output_array.data = AI_PTR(g_mnist_activations_map[0] + 0);
    serving_default_input_layer_30_output_array.data_start = AI_PTR(g_mnist_activations_map[0] + 0);
    gemm_0_output_array.data = AI_PTR(g_mnist_activations_map[0] + 3136);
    gemm_0_output_array.data_start = AI_PTR(g_mnist_activations_map[0] + 3136);
    nl_0_nl_output_array.data = AI_PTR(g_mnist_activations_map[0] + 0);
    nl_0_nl_output_array.data_start = AI_PTR(g_mnist_activations_map[0] + 0);
    gemm_1_output_array.data = AI_PTR(g_mnist_activations_map[0] + 512);
    gemm_1_output_array.data_start = AI_PTR(g_mnist_activations_map[0] + 512);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_mnist_weights_map, 1, params)) {
    ...
    gemm_0_weights_array.data = AI_PTR(g_mnist_weights_map[0] + 0);
    gemm_0_weights_array.data_start = AI_PTR(g_mnist_weights_map[0] + 0);
    gemm_0_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_0_bias_array.data = AI_PTR(g_mnist_weights_map[0] + 401408);
    gemm_0_bias_array.data_start = AI_PTR(g_mnist_weights_map[0] + 401408);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_mnist_weights_map[0] + 401920);
    gemm_1_weights_array.data_start = AI_PTR(g_mnist_weights_map[0] + 401920);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_mnist_weights_map[0] + 434688);
    gemm_1_bias_array.data_start = AI_PTR(g_mnist_weights_map[0] + 434688);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_mnist_weights_map[0] + 434944);
    gemm_2_weights_array.data_start = AI_PTR(g_mnist_weights_map[0] + 434944);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_mnist_weights_map[0] + 437504);
    gemm_2_bias_array.data_start = AI_PTR(g_mnist_weights_map[0] + 437504);
    return true;
  }
