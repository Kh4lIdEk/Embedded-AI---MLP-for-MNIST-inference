...
#define AI_MNIST_DATA_ACTIVATIONS_SIZES \
  { 3648, }
#define AI_MNIST_DATA_ACTIVATIONS_SIZE     (3648)
#define AI_MNIST_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MNIST_DATA_ACTIVATION_1_SIZE    (3648)



#define AI_MNIST_DATA_WEIGHTS_SIZES \
  { 437544, }
#define AI_MNIST_DATA_WEIGHTS_SIZE         (437544)
#define AI_MNIST_DATA_WEIGHTS_COUNT        (1)
#define AI_MNIST_DATA_WEIGHT_1_SIZE        (437544)
